...
var UserCoursesService = (function () {
    function UserCoursesService(orlp) {
        this.orlp = orlp;
    }
    UserCoursesService.prototype.getCourses = function () {
    ...
    UserCoursesService.prototype.handleError = function (error) {
        console.error(error);
        return Observable_1.Observable.throw(error.json().error || 'Server error');
    };
    return UserCoursesService;
}());
UserCoursesService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [orlp_service_1.ORLPService])
], UserCoursesService);
exports.UserCoursesService = UserCoursesService;
//# sourceMappingURL=user.courses.service.js.map